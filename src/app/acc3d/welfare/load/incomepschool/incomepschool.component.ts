...
@Component({
  selector: 'app-incomepschool',
  templateUrl: './incomepschool.component.html',
  styleUrls: ['./incomepschool.component.scss']
})
export class IncomepschoolComponent implements OnInit {
  title = 'angular-app';
