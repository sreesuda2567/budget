...
@Component({
  selector: 'app-epmedical-summonth',
  templateUrl: './epmedical-summonth.component.html',
  styleUrls: ['./epmedical-summonth.component.scss']
})
export class EpmedicalSummonthComponent implements OnInit {
 title = 'angular-app';
  ...
  locales = listLocales();
  rownum: any;
  url = "/acc3d/welfare/report/epmedical_summonth.php";
...
fetchdata() {
  ...
  fetchdatadetail(CODE:any,MONTHNAME:any,FACULTY_CODE:any,FACULTY_TNAME:any){ 
    this.dataAdd.MONTH=CODE;
    this.dataAdd.MONTHNAME=MONTHNAME;
    this.dataAdd.FACULTY_NAME=FACULTY_CODE;
    this.dataAdd.FACULTYNAME=FACULTY_TNAME;
  ...
  getMonthTotal(month: string): number {
    ...
    return this.datalist.reduce((sum: number, item: any) => {
