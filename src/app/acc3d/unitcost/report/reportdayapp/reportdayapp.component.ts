...
@Component({
  selector: 'app-reportdayapp',
  templateUrl: './reportdayapp.component.html',
  styleUrls: ['./reportdayapp.component.scss']
})
export class ReportdayappComponent implements OnInit {
  title = 'angular-app';
  ...
  rownum: any;
  dataNameb: any;
  url = "/acc3d/appmoney/report/reportdayapp.php";
