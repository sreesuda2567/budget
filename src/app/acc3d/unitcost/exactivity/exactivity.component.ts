...
@Component({
  selector: 'app-exactivity',
  templateUrl: './exactivity.component.html',
  styleUrls: ['./exactivity.component.scss']
})
export class ExactivityComponent implements OnInit {
  title = 'angular-app';
  ...
  dataYear :any;
  dataCam :any;
  url = "/acc3d/unitcost/report/activity.php";
...
fetchdataexpen(opt:any,plpro:any,fac:any,code:any,name:any,colum:any){ 
  ...
  this.dataAdd.PLPRODUCT_CODE = plpro;
