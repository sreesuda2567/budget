...
@Component({
  selector: 'app-reportrm4',
  templateUrl: './reportrm4.component.html',
  styleUrls: ['./reportrm4.component.scss']
})
export class Reportrm4Component implements OnInit {
  title = 'angular-app';
  ...
  dataYear :any;
  dataCam :any;
  url = "/acc3d/unitcost/report/reportrm.php";
  ...
  .subscribe((data: any) => {
   // console.log(data);
    ...
    this.dataAdd.CRPART_ID = data[0].CRPART_ID;
        ...
        var Table = {
          "opt": "viewTable",
          "Table":"PLINCOME where PLINCOME_ASTATUS=1 and PLINCOME_CODE='02' or PLINCOME_CODE='10' or PLINCOME_CODE='14'"
        }
        this.apiService
