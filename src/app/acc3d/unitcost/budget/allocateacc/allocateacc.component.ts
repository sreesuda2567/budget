...
@Component({
  selector: 'app-allocateacc',
  templateUrl: './allocateacc.component.html',
  styleUrls: ['./allocateacc.component.scss']
})
export class AllocateaccComponent implements OnInit {
  datalist: any;
  datalistp: any;
  loading: any;
  rownum: any;
  ...
  url3 = "/acc3d/unitcost/userpermission.php";
  ...
  fetchdata() {
    ...
    this.apiService.getdata(varPT, this.url3)
      .pipe(first())
      .subscribe((data: any) => {
    ...
    this.apiService
      ...
      .subscribe((data: any) => {
        ...
        this.apiService
          .getdata(varPl, this.url1)
          .pipe(first())
          .subscribe((data: any) => {
            this.dataplmoney = data;
            this.dataAdd.PLMONEYPAY_CODE = '2Y';
          });
      });
    var varPm = {
      "opt": "CRPARTM"
    ...
    this.apiService
      ...
      .subscribe((data: any) => {
        ...
        var varN = {
          "opt": "viewfacf",
          "citizen": this.tokenStorage.getUser().citizen,
          "PRIVILEGERSTATUS": this.PRIVILEGE_RSTATUS,
          "CAMPUS_CODE": this.dataAdd.CAMPUS_CODE
        }
        this.apiService
          .getdata(varN, this.url3)
          .pipe(first())
          .subscribe((data: any) => {
            this.dataFac = data;
