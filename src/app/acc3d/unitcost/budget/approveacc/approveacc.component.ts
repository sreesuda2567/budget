...
@Component({
  ...
  templateUrl: './approveacc.component.html',
  styleUrls: ['./approveacc.component.scss']
})
export class ApproveaccComponent implements OnInit {
  title = 'angular-app';
  ...
  Mrmoney = 0;
  rownum: any;
  url = "/acc3d/unitcost/manage/approveacc.php";
      ...
      .subscribe((data: any) => {
        if (data.status == '1') {
          ...
          for (let i = 0; i < this.datalist.length; i++) {
            ...
            this.dataAdd.FNEXACC_DETAIL[i] = 'เลข 3 ดี:' + this.datalist[i].FNEXPENSES_STEP+'เลขฎีกา:' + this.datalist[i].FNEXACC_DEKA + ' ' + this.datalist[i].FACULTY_TNAME;
