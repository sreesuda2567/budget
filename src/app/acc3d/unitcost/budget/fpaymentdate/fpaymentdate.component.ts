...
@Component({
  selector: 'app-fpaymentdate',
  templateUrl: './fpaymentdate.component.html',
  styleUrls: ['./fpaymentdate.component.scss']
})
export class FpaymentdateComponent implements OnInit {
 title = 'angular-app';
  ...
  rowpbi: any;
  rowpbu: any;
  url = "/acc3d/unitcost/manage/fpaymentdates.php";
  ...
  ngOnInit(): void {
    ...
    this.dataAdd.FNEXACCPAYDATE_TYPE1  = 'PM';
    this.dataAdd.FNEXACCPAYDATE_TYPE  = 'PM';
    this.rownum1 = 1;
  }
fetchdata() {
    var varP = {
