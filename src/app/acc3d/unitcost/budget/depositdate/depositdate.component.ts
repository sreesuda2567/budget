...
@Component({
  selector: 'app-depositdate',
  templateUrl: './depositdate.component.html',
  styleUrls: ['./depositdate.component.scss']
})
export class DepositdateComponent implements OnInit {
  title = 'angular-app';
  ...
  rowpbi: any;
  rowpbu: any;
  url = "/acc3d/unitcost/manage/depositdate.php";
  ...
  editdata(id: any, name: any) {
    ...
    this.apiService
      ...
      .pipe(first())
      .subscribe((data: any) => {
        this.dataAdd.FNEXACCPAYDATE_CODE = data[0].FNEXACCMONEYDATE_CODE;
        this.dataAdd.FNEXACCPAYDATE_NUMBER = data[0].FNEXACCMONEYDATE_NUMBER;
        this.dataAdd.FNEXACCPAYDATE_NOTE = data[0].FNEXACCMONEYDATE_NOTE;
        this.dataAdd.FNEXACCPAYDATE_MONEY = this.numberWithCommas(parseFloat(data[0].FNEXACCMONEYDATE_MONEY).toFixed(2));
        this.dataAdd.DATENOWP = new Date(data[0].FNEXACCMONEYDATE_DATEPD);
