...
@Component({
  selector: 'app-rqtasset',
  templateUrl: './rqtasset.component.html',
  styleUrls: ['./rqtasset.component.scss']
})
export class RqtassetComponent implements OnInit {
  name = 'Angular';
  ...
  dataYearimport: any;
  rownumimport: any;
  url = "/acc3d/rqbudget/budget/rqasset.php";
