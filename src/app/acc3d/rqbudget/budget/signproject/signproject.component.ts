...
@Component({
  selector: 'app-signproject',
  templateUrl: './signproject.component.html',
  styleUrls: ['./signproject.component.scss']
})
export class SignprojectComponent {
  dataFac: any;
  dataIncome: any;
  dataCrpart: any;
  dataYear: any;
  ...
  url = "/acc3d/rqbudget/submit/signproject.php";
         ...
         if (result.value) {
           this.apiService
             ...
             .subscribe((data: any) => {
               ...
               if (data.status == 1) {
                 this.fetchdatalistapp();
                 this.toastr.success("แจ้งเตือน:ลงนามโครงการเรียบร้อยแล้ว");
               }else{
                 this.toastr.warning("แจ้งเตือน:ไม่สามารถลงนามโครงการได้");
               }
             });
         }
       });
