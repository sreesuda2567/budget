...
@Component({
  selector: 'app-smbuilding',
  templateUrl: './smbuilding.component.html',
  styleUrls: ['./smbuilding.component.scss']
})
export class SmbuildingComponent implements OnInit {
dataFac: any;
  dataIncome: any;
  dataCrpart: any;
  dataYear: any;
  ...
  url = "/acc3d/rqbudget/submit/smbuilding.php";
