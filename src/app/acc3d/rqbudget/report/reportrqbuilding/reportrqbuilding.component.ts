...
@Component({
  selector: 'app-reportrqbuilding',
  templateUrl: './reportrqbuilding.component.html',
  styleUrls: ['./reportrqbuilding.component.scss']
})
export class ReportrqbuildingComponent implements OnInit {
title = 'angular-app';
  ...
  datalistdetail :any;
  dataMyear:any;
  url = "/acc3d/rqbudget/report/reportrqbuilding.php";
