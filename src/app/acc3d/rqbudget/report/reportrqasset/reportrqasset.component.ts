...
@Component({
  selector: 'app-reportrqasset',
  templateUrl: './reportrqasset.component.html',
  styleUrls: ['./reportrqasset.component.scss']
})
export class ReportrqassetComponent implements OnInit {
title = 'angular-app';
  ...
  datalistdetail :any;
  dataMyear:any;
  url = "/acc3d/rqbudget/report/reportrqasset.php";
...
fetchdataCam(){
  ...
  /*exportexcel(): void
  {
    ...
    XLSX.utils.book_append_sheet(wb, wsdetail, 'รายการครุภัณฑ์');
 ...
 centerAlignHeader(ws: XLSX.WorkSheet) {
   ...
   ws["!merges"] = [
     ...
     { s: { r: 3, c: 6 }, e: { r: 4, c: 6 } }, // งบประมาณ
 
     // "วัตถุประสงค์ของครุภัณฑ์
     { s: { r: 3, c: 7 }, e: { r: 3, c: 11 } },
