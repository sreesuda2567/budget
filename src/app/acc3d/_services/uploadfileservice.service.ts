...
export class UploadfileserviceService {
  ...
  uploadsig(file: File,fac:any,id:any): Observable<HttpEvent<any>> {
    ...
    uploadfamily(file: File,file1: File,file2: File,fac:any,id:any): Observable<HttpEvent<any>> {
    const formData: FormData = new FormData();
    formData.append('file', file);
    ...
    const req = new HttpRequest('POST', `${this.baseUrlsig}/uploadfamily.php`, formData, {
      reportProgress: true,
      responseType: 'text'
    });
