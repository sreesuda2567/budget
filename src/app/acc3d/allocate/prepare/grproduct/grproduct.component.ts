...
@Component({
  selector: 'app-grproduct',
  templateUrl: './grproduct.component.html',
  styleUrls: ['./grproduct.component.scss']
})
export class GrproductComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  searchTerm: any;
  ...
  dataplmoneytype: any
  url = "/acc3d/allocate/prepare/grproduct.php";
...
setshowbti(){
  this.htmlStringd = 'เพิ่มผลผลิตของรัฐ';
  this.dataAdd.PLGPRODUCT_CODE = '';
  this.dataAdd.PLGPRODUCT_NAME = '';
  this.dataAdd.PLGPRODUCT_SHORTNAME = '';
  this.dataAdd.PLGPRODUCT_ASTATUS = '';
}  
showinput() {
  this.rowpbi = 1;
  this.rowpbu = '';
