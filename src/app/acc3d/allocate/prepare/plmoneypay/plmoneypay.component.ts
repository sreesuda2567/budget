...
@Component({
  selector: 'app-plmoneypay',
  templateUrl: './plmoneypay.component.html',
  styleUrls: ['./plmoneypay.component.scss']
})
export class PlmoneypayComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  searchTerm: any;
  ...
  dataplmoneytype: any
  url = "/acc3d/allocate/prepare/plmoneypay.php";
...
setshowbti(){
  this.htmlStringd = 'เพิ่มหมวดรายจ่าย';
  this.dataAdd.PLMONEYPAY_CODE = '';
  this.dataAdd.PLMONEYPAY_NAME = '';
  this.dataAdd.PLMONEYPAY_ASTATUS = '';
