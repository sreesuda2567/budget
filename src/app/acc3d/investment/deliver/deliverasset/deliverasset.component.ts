...
@Component({
  selector: 'app-deliverasset',
  templateUrl: './deliverasset.component.html',
  styleUrls: ['./deliverasset.component.scss']
})
export class DeliverassetComponent implements OnInit {
  dataFac: any;
  dataIncome: any;
  dataCrpart: any;
  dataYear: any;
  ...
  url = "/acc3d/investment/deliver/deliverasset.php";
