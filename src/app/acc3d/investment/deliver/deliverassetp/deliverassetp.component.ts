...
@Component({
  selector: 'app-deliverassetp',
  templateUrl: './deliverassetp.component.html',
  styleUrls: ['./deliverassetp.component.scss']
})
export class DeliverassetpComponent implements OnInit {
  dataFac: any;
  dataIncome: any;
  dataCrpart: any;
  dataYear: any;
  ...
  url = "/acc3d/investment/deliver/deliverassetp.php";
