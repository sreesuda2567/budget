...
@Component({
  selector: 'app-deliverproject',
  templateUrl: './deliverproject.component.html',
  styleUrls: ['./deliverproject.component.scss']
})
export class DeliverprojectComponent implements OnInit {
  dataFac: any;
  dataIncome: any;
  dataCrpart: any;
  dataYear: any;
  ...
  insertdataapp() {
    ...
    if (count == 0) {
      ...
      Swal.fire({
        title: 'ต้องการนำส่งข้อมูลรายการโครงการ ทั้งหมด ' + count + ' รายการ จำนวนเงิน ' + this.numberWithCommas(num.toFixed(2)) + ' บาท',
        icon: 'warning',
