...
@Component({
  selector: 'app-approvefacbuilding',
  templateUrl: './approvefacbuilding.component.html',
  styleUrls: ['./approvefacbuilding.component.scss']
})
export class ApprovefacbuildingComponent implements OnInit {
  dataFac: any;
  dataIncome: any;
  dataCrpart: any;
  dataYear: any;
