...
@Component({
  selector: 'app-approvefacassetp',
  templateUrl: './approvefacassetp.component.html',
  styleUrls: ['./approvefacassetp.component.scss']
})
export class ApprovefacassetpComponent implements OnInit {
  dataFac: any;
  dataIncome: any;
  dataCrpart: any;
  dataYear: any;
  ...
  showapp(code: any, name: any, mail: any) {
    this.clickshow = true;
