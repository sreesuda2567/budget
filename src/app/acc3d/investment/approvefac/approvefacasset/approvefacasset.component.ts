...
@Component({
  selector: 'app-approvefacasset',
  templateUrl: './approvefacasset.component.html',
  styleUrls: ['./approvefacasset.component.scss']
})
export class ApprovefacassetComponent implements OnInit {
  dataFac: any;
  dataIncome: any;
  dataCrpart: any;
  dataYear: any;
  ...
  datastatus: any
  dataAdd: any = {};
  url = "/acc3d/investment/passet/listasset.php";
