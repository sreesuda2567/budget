...
@Component({
  selector: 'app-reportbuilding',
  templateUrl: './reportbuilding.component.html',
  styleUrls: ['./reportbuilding.component.scss']
})
export class ReportbuildingComponent implements OnInit {
  title = 'angular-app';
  ...
  dataPlproduct :any;
  loading:any;
  url = "/acc3d/investment/report/reportbuilding.php";
