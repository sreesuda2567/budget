...
@Component({
  selector: 'app-reportplanasset',
  templateUrl: './reportplanasset.component.html',
  styleUrls: ['./reportplanasset.component.scss']
})
export class ReportplanassetComponent implements OnInit {
  title = 'angular-app';
  ...
  datalistyear:any ;
  datadetail:any ;
  url = "/acc3d/investment/report/reportplanasset.php";
