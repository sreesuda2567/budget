...
@Component({
  selector: 'app-reportsplanbuilding',
  templateUrl: './reportsplanbuilding.component.html',
  styleUrls: ['./reportsplanbuilding.component.scss']
})
export class ReportsplanbuildingComponent implements OnInit {
  title = 'angular-app';
  ...
  datalistdetail :any;
  dataMyear:any;
  url = "/acc3d/investment/report/reportsplanbuilding.php";
...
fetchdataCam(){
 ...
 XLSX.utils.book_append_sheet(wb, wsdetail, 'รายการสิ่งก่อสร้าง');
    ...
    exportexcel(): void {
      ...
      // ✅ บันทึกไฟล์ Excel
      XLSX.writeFile(wb, "รายงานแผนความต้องการสิ่งก่อสร้าง.xlsx");
  }
