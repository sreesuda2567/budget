...
//import * as XLSX from 'xlsx';
@Component({
  selector: 'app-reportsplanasset',
  templateUrl: './reportsplanasset.component.html',
  styleUrls: ['./reportsplanasset.component.scss']
})
export class ReportsplanassetComponent implements OnInit {
  title = 'angular-app';
  ...
  datalistdetail :any;
  dataMyear:any;
  url = "/acc3d/investment/report/reportsplanasset.php";
