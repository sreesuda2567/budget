...
@Component({
  selector: 'app-reportplanbuilding',
  templateUrl: './reportplanbuilding.component.html',
  styleUrls: ['./reportplanbuilding.component.scss']
})
export class ReportplanbuildingComponent implements OnInit {
  title = 'angular-app';
  ...
  dataPlproduct :any;
  datalistyear:any ;
  url = "/acc3d/investment/report/reportplanbuilding.php";
