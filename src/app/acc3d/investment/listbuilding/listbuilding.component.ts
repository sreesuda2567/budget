...
@Component({
  selector: 'app-listbuilding',
  templateUrl: './listbuilding.component.html',
  styleUrls: ['./listbuilding.component.scss']
})
...
*/
 ...
 // param: any = { MASSAGE_CITIZEN: null }
  ...
  dataYearimport:any;
  rownumimport:any; 
  url = "/acc3d/investment/building/listbuilding.php";
...
onChangerequest(event: any) {
  ...
  //แก้ไขข้อมูล
  updatedata(){ 
    this.Uploadfiles.uploadbuil(this.file,this.fileict,this.filerequest,this.dataAdd.PRYEARASSET_CODE,this.dataAdd.FACULTY_CODE,this.dataAdd.PRBUILDING_CODE)
    .subscribe((event: any) => {
