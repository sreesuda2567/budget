...
export class YearComponent implements OnInit {
  ...
  rownum:any;
  searchTerm: any;
  url = "/acc3d/investment/manage/year.php";
...
insertdata(){ 
  if(this.dataAdd.PRYEARASSET_CODE =='' || this.dataAdd.PRYEARASSET_NAME =='' || this.dataAdd.PRYEARASSET_RSTATUS =='' ){
    if(this.dataAdd.PRYEARASSET_CODE ==''){
     this.toastr.warning("แจ้งเตือน:กรุณากรอกรหัสปีงบประมาณ");
    }
    if(this.dataAdd.PRYEARASSET_NAME ==''){
