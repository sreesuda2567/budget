...
@Component({
  selector: 'app-transferannal',
  templateUrl: './transferannal.component.html',
  styleUrls: ['./transferannal.component.scss']
})
export class TransferannalComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  dataName: any;
  dataNameb: any;
  url = "/acc3d/appmoney/annal/transferannal.php";
