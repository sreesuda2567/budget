...
@Component({
  ...
  templateUrl: './writecheck.component.html',
  styleUrls: ['./writecheck.component.scss']
})
export class WritecheckComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  dataName: any;
  dataNameb: any;
  url = "/acc3d/appmoney/annal/writecheck.php";
