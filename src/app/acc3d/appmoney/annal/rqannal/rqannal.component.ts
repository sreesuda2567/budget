...
@Component({
  selector: 'app-rqannal',
  templateUrl: './rqannal.component.html',
  styleUrls: ['./rqannal.component.scss']
})
export class RqannalComponent implements OnInit {
datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  dataName: any;
  dataNameb: any;
  url = "/acc3d/appmoney/annal/rqannal.php";
...
fetchdata() {
  ...
  editdata(id: any,id2: any,mon: any,mon1: any) {
    this.setshowbti();
    this.onChangechief();
    this.onChangeedoc();
  ...
  // ฟังก์ขันสำหรับการนำข้อมูลมาแสดงเพื่อแก้ไข
  editdatapp(id: any, ciz1: any, ciz2: any,mon: any,mon1: any) {
    this.setshowbti();
    this.onChangechief();
    this.onChangeedoc();
    this.dataAdd.FNANNALSMAP_CODE = id;
    this.dataAdd.CHIEF_CODE = ciz1;
    this.dataAdd.DEPARTMENT_CODE = ciz2;
    this.dataAdd.FNANNALS_MONEYC = mon;
    this.dataAdd.FNALLBW_AMOUNT = mon1;
    this.rowpbi = '';
    this.rowpbu = 1;
