...
@Component({
  ...
  templateUrl: './clearcheck.component.html',
  styleUrls: ['./clearcheck.component.scss']
})
export class ClearcheckComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  dataName: any;
  dataNameb: any;
  url = "/acc3d/appmoney/annal/clearcheck.php";
  ...
  editdatapp(id: any,id2: any, link: any, ciz: any, money: any) {
    this.setshowbti();
    this.fetchdatareport();
    this.dataAdd.FNANNALS_CODE = id;
    ...
    if (this.dataAdd.EBOOKREQ_FILE == '') {
      ...
      this.apiService
        ...
        .subscribe((data: any) => {
          ...
          if (data.status == 1) {
            this.Uploadfiles.uploadcontract(this.file, this.dataAdd.FACULTY_CODE, this.dataAdd.PLYEARBUDGET_CODE, this.dataAdd.FNANNALS_CODE, this.dataAdd.citizen, '56')
              .subscribe((event: any) => {
                // 
                if (event.type == 4) {
                }
