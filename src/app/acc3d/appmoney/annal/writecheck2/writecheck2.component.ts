...
@Component({
  selector: 'app-writecheck2',
  templateUrl: './writecheck2.component.html',
  styleUrls: ['./writecheck2.component.scss']
})
export class Writecheck2Component implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  dataName: any;
  dataNameb: any;
  url = "/acc3d/appmoney/annal/writecheck2.php";
