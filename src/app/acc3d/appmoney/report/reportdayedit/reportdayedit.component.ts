...
@Component({
  selector: 'app-reportdayedit',
  templateUrl: './reportdayedit.component.html',
  styleUrls: ['./reportdayedit.component.scss']
})
export class ReportdayeditComponent implements OnInit {
 title = 'angular-app';
  ...
  rownum: any;
  dataNameb: any;
  url = "/acc3d/appmoney/report/reportdayedit.php";
