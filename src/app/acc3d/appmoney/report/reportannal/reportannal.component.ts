...
@Component({
  selector: 'app-reportannal',
  templateUrl: './reportannal.component.html',
  styleUrls: ['./reportannal.component.scss']
})
export class ReportannalComponent implements OnInit {
  title = 'angular-app';
  ...
  rownum: any;
  dataNameb: any;
  url = "/acc3d/appmoney/report/reportannal.php";
  ...
  insertdata() {
    ...
    if (this.dataAdd.CITIZEN_IDA == '') {
      ...
      if (this.dataAdd.CITIZEN_IDA == '') {
        this.toastr.warning("แจ้งเตือน:กรุณาเลือกผู้ลงนามรายงานคนที่ 1");
      }
