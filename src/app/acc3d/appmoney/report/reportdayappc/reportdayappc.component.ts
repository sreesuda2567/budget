...
@Component({
  selector: 'app-reportdayappc',
  templateUrl: './reportdayappc.component.html',
  styleUrls: ['./reportdayappc.component.scss']
})
export class ReportdayappcComponent implements OnInit {
title = 'angular-app';
