...
@Component({
  selector: 'app-reportsign',
  templateUrl: './reportsign.component.html',
  styleUrls: ['./reportsign.component.scss']
})
export class ReportsignComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  dataName: any;
  dataNameb: any;
  url = "/acc3d/appmoney/report/reportsign.php";
