...
@Component({
  selector: 'app-load3d',
  templateUrl: './load3d.component.html',
  styleUrls: ['./load3d.component.scss']
})
export class Load3dComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  dataName: any;
  dataNameb: any;
  url = "/acc3d/appmoney/other/load3d.php";
  ...
  // ฟังก์ขันสำหรับการนำข้อมูลมาแสดงเพื่อแก้ไข
  editdatapp(id: any, ciz1: any, ciz2: any, code: any, edoc: any, chief: any, deka: any,doc:any,date:any,link:any) {
    this.setshowbti();
    this.onChangeedoc();
    this.onChangechief();
    ...
    this.dataAdd.FNANNALSMAP_DOC = doc;
     if(date != null){
    this.dataAdd.DATENOWF = new Date(date);
     }
  ...
  insertdata() {
    ...
    /*  if (this.dataAdd.CITIZEN_IDC1 == '') {
        this.toastr.warning("แจ้งเตือน:กรุณาเลือก อม.1");
      }
      if (this.dataAdd.CITIZEN_IDC2 == '') {
        this.toastr.warning("แจ้งเตือน:กรุณาเลือก อม. 2");
      }*/
