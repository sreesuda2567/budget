...
@Component({
  ...
  templateUrl: './load3dface.component.html',
  styleUrls: ['./load3dface.component.scss']
})
export class Load3dfaceComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  datarstatus: any;
  dataName: any;
  url = "/acc3d/appmoney/other/load3df.php";
          ...
          this.apiService
            ...
            .subscribe((data2: any) => {
              ...
              if (data2 && data2.length > 0) {
                this.dataAdd.CITIZEN_IDD1 = data2[0].CITIZEN_ID;
              }
            });
        }
      });
