...
@Component({
  selector: 'app-contractotherw',
  templateUrl: './contractotherw.component.html',
  styleUrls: ['./contractotherw.component.scss']
})
export class ContractotherwComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  file: any;
  ...
  dataName: any;
  dataNameb: any;
  url = "/acc3d/appmoney/other/contractotherw.php";
...
fetchdatareport() {
  ...
  // ฟังก์ขันสำหรับการนำข้อมูลมาแสดงเพื่อแก้ไข
  editdatapp(id: any,  ciz: any,  ciz2: any, link: any ){
    this.setshowbti();
    this.fetchdatareport(); 
