...
@Component({
  selector: 'app-estimateelectricity',
  templateUrl: './estimateelectricity.component.html',
  styleUrls: ['./estimateelectricity.component.scss']
})
export class EstimateelectricityComponent implements OnInit {
  title = 'angular-app';
