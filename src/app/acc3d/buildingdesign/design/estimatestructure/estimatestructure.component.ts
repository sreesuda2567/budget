...
@Component({
  selector: 'app-estimatestructure',
  templateUrl: './estimatestructure.component.html',
  styleUrls: ['./estimatestructure.component.scss']
})
export class EstimatestructureComponent implements OnInit {
  title = 'angular-app';
...
setshowbti() {
  this.dataAdd.BDSTRUCTURE_MONEY=0;
  for(let i=0; i<4;i++){
...
editdata(id: any) {
  ...
  this.apiService
    ...
    .subscribe((data: any) => {
      ...
      if(data[0].BDSTRUCTURE_MONEY !=null){
