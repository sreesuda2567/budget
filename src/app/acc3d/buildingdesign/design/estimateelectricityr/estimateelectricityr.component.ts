...
@Component({
  selector: 'app-estimateelectricityr',
  templateUrl: './estimateelectricityr.component.html',
  styleUrls: ['./estimateelectricityr.component.scss']
})
export class EstimateelectricityrComponent implements OnInit {
  title = 'angular-app';
  ...
  rownum: any;
  dataMyear: any;
  url = "/acc3d/buildingdesign/design/estimateelectricity.php";
...
editdata(id: any) {
  ...
  this.apiService
    ...
    .pipe(first())
    .subscribe((data: any) => {
      this.dataAdd.BDELECTRIC_CODE = data[0].BDOPERATION_CODE;
