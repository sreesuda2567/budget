...
@Component({
  selector: 'app-report-projectid',
  templateUrl: './report-projectid.component.html',
  styleUrls: ['./report-projectid.component.scss']
})
export class ReportProjectidComponent implements OnInit {
  title = 'angular-app';
  ...
  url = "/acc3d/budget/report/reportprojectid.php";
...
isBoldLevel(level: string): boolean {
  return [
    'mission',
    'estimate_plan',
    'strategy',
