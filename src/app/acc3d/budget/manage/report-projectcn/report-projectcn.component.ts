...
@Component({
  selector: 'app-report-projectcn',
  templateUrl: './report-projectcn.component.html',
  styleUrls: ['./report-projectcn.component.scss']
})
export class ReportProjectcnComponent implements OnInit {
  title = 'angular-app';
  ...
  Mrmoney= 0;
  rownum:any;
  url = "/acc3d/budget/report/reportprojectcn.php";
