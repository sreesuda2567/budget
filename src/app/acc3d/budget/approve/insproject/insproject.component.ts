...
@Component({
  selector: 'app-insproject',
  templateUrl: './insproject.component.html',
  styleUrls: ['./insproject.component.scss']
})
export class InsprojectComponent implements OnInit {
  ...
  statusreport: any;
  statusreportp: any;
  url = "/acc3d/allocate/manage/project.php";
...
this.apiService
  ...
  editdata(id: any, type: any) {
   ...
   .subscribe((data: any) => {//datalisttd
    ...
    this.dataAdd.PLPROJECT_RSTATUS= data.data[0].PLPROJECT_RSTATUS;
  ...
  updatedata() {
    ...
    if (this.dataAdd.PLPROJECT_NAME == '' || this.dataAdd.PLPROJECT_SDATE == '' || this.dataAdd.PLPROJECT_EDATE == '' || this.dataAdd.FACULTY_CODE1 == ''
