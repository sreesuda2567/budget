...
@Component({
  selector: 'app-mallocate',
  templateUrl: './mallocate.component.html',
  styleUrls: ['./mallocate.component.scss']
})
export class MallocateComponent implements OnInit {
  datalist: any;
  datalistp: any;
  loading: any;
  rownum: any;
  ...
  fetchdata() {
    ...
    this.apiService.getdata(varPT, this.url2)
      .pipe(first())
      .subscribe((data: any) => {
      ...
      .subscribe((data: any) => {
        ...
        this.apiService
          ...
          .subscribe((data: any) => {
            ...
            this.dataAdd.PLMONEYPAY_CODE = '2L';
          });
      });
    var varPm = {
      "opt": "CRPARTM"
