...
@Component({
  selector: 'app-reporttrain',
  templateUrl: './reporttrain.component.html',
  styleUrls: ['./reporttrain.component.scss']
})
export class ReporttrainComponent implements OnInit {
    title = 'angular-app';
    ...
    locales = listLocales();
    rownum:any;
    url = "/acc3d/budget/report/reporttrain.php";
