...
@Component({
  selector: 'app-typefac',
  templateUrl: './typefac.component.html',
  styleUrls: ['./typefac.component.scss']
})
export class TypefacComponent implements OnInit {
  datalist: any;
  loading: any;
  rownum: any;
  searchTerm: any;
...
insertdata(){ 
if(this.dataAdd.TYPEFACULTY_CODE =='' || this.dataAdd.TYPEFACULTY_NAME ==''  ){
...
setshowbti(){
  this.htmlStringd = 'เพิ่มประเภทหน่วยงาน';
  this.dataAdd.TYPEFACULTY_CODE = '';
  this.dataAdd.TYPEFACULTY_NAME = '';
}  
showinput() {
  this.rowpbi = 1;
  this.rowpbu = '';
