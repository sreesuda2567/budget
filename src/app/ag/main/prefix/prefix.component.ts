...
insertdata(){ 
if(this.dataAdd.PREFIXOFFICE_CODE =='' || this.dataAdd.PREFIXOFFICE_TNAME ==''  ){
...
setshowbti(){
  this.htmlStringd = 'เพิ่มคำนามหน่วยงาน';
  this.dataAdd.PREFIXOFFICE_CODE = '';
  this.dataAdd.PREFIXOFFICE_TNAME = '';
}  
showinput() {
  this.rowpbi = 1;
  this.rowpbu = '';
