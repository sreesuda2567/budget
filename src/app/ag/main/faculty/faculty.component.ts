...
// ฟังก์ชัน การแสดงข้อมูลตามต้องการdataPrefix
fetchdatalist() {
...
insertdata(){ 
if(this.dataAdd.CAMPUS_CODE =='' || this.dataAdd.UNIVERSITY_CODE =='' || this.dataAdd.CAMPUS_TNAME ==''  ){
...
setshowbti(){
this.htmlStringd = 'เพิ่มวิทยาเขต';
this.dataAdd.FACULTY_CODE = '';
this.dataAdd.CAMPUS_CODE = '';
this.dataAdd.FACULTY_TNAME = '';
this.dataAdd.FACULTY_ENAME = '';
this.dataAdd.FACULTY_HADDR = '';
this.dataAdd.FACULTY_MOO = '';
this.dataAdd.FACULTY_STREET = '';
this.dataAdd.FACULTY_DISTRICT = '';
this.dataAdd.FACULTY_CITY = '';
this.dataAdd.FACULTY_ZIPCODE = '';
this.dataAdd.FACULTY_PHONE = '';
this.dataAdd.FACULTY_FAX = '';
this.dataAdd.FACULTY_EMAIL = '';
}  
showinput() {
this.rowpbi = 1;
this.rowpbu = '';
