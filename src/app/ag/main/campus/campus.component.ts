...
setshowbti(){
  ...
  this.dataAdd.CAMPUS_TNAME = '';
  this.dataAdd.CAMPUS_ENAME = '';
  this.dataAdd.CAMPUS_HADDR = '';
  this.dataAdd.CAMPUS_MOO = '';
  this.dataAdd.CAMPUS_STREET = '';
  this.dataAdd.CAMPUS_DISTRICT = '';
  this.dataAdd.CAMPUS_CITY = '';
  this.dataAdd.CAMPUS_ZIPCODE = '';
  this.dataAdd.CAMPUS_PHONE = '';
  this.dataAdd.CAMPUS_FAX = '';
  this.dataAdd.CAMPUS_EMAIL = '';
}  
showinput() {
  this.rowpbi = 1;
  this.rowpbu = '';
