...
setshowbti(){
this.htmlStringd = 'เพิ่มหลักสูตร/ฝ่ายงาน';
this.dataAdd.SECTION_CODE = '';
this.dataAdd.SECTION_TNAME = '';
this.dataAdd.SECTION_ENAME = '';
this.dataAdd.SECTION_PHONE = '';
this.dataAdd.SECTION_FAX = '';
this.dataAdd.SECTION_EMAIL = '';
}  
showinput() {
this.rowpbi = 1;
this.rowpbu = '';
