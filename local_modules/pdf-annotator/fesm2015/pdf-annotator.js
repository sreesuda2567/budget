...
import { InjectionToken, Injectable, Optional, Inject, EventEmitter, Component, NgZone, ChangeDetectorRef, Input, ViewChildren, ViewChild, Output, HostListener, ChangeDetectionStrategy, NgModule, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
PdfManagerService.ɵprov = i0.ɵɵdefineInjectable({ factory: function PdfManagerService_Factory() { return new PdfManagerService(i0.ɵɵinject(i1.HttpClient), i0.ɵɵinject(PDF_ANNOTATOR_CONFIG, 8)); }, token: PdfManagerService, providedIn: "root" });
...
class PdfAnnotatorModalComponent {
            ...
            const alert = yield this.alertCtrl.create({
                ...
                buttons: [
                    { text: 'ยกเลิก', role: 'cancel' },
                    {
                        text: 'ย้าย',
                        handler: (data) => {
                            const to = parseInt(data === null || data === void 0 ? void 0 : data.target, 10);
    ...
    moveToPage(fromPage, toPage) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.reorderPage(fromPage, toPage);
            this.pageNo = toPage;
...
export { PDF_ANNOTATOR_CONFIG, PdfAnnotatorModalComponent, PdfAnnotatorModule, PdfManagerService, SvgIconComponent as ɵa };
