...
class PdfAnnotatorModalComponent {
    ...
    applyDeskew() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const pdfDoc = yield PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true });
                let modified = false;
                ...
                for (let i = totalPages - 1; i >= 0; i--) {
                    ...
                    if (rot && rot !== 0) {
                        ...
                        if (rot % 90 === 0) {
                            oldPage.setRotation(degrees(oldPage.getRotation().angle + rot), { ignoreEncryption: true });
                        }
                        else {
                ...
                if (modified) {
                    ...
                    const loadingTask = pdfjsLib.getDocument({ data: this.basePdfBytes });
                    ...
                    const tmpDoc = yield PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true });
    ...
    executeSplitPdf() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const sourceDoc = yield PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true });
                const newDoc = yield PDFDocument.create();
                const sortedPages = Array.from(pagesToKeep, { ignoreEncryption: true }).sort((a, b) => a - b);
    ...
    undoPageOp() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    const tmpDoc = yield PDFDocument.load(copy, { ignoreEncryption: true });
                    tmpDoc.getPages().forEach((pg, idx) => {
    ...
    loadPdfBytesAndInitPdfjs() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    const tmpDoc = yield PDFDocument.load(buffer, { ignoreEncryption: true });
                    tmpDoc.getPages().forEach((pg, idx) => {
                        const { width, height } = pg.getSize();
                        this.pdfPageAspects.set(idx + 1, width / height);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const filterAndShift = (arr) => arr
                    .filter(a => a.page !== deletedPage, { ignoreEncryption: true })
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (file.type.startsWith('image/')) {
                ...
                try {
                    ...
                    const importedPdf = yield PDFDocument.load(arrayBuffer, { ignoreEncryption: true });
                    const mainPdf = yield PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true });
    ...
    saveDocument() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // Structurally rotates pages (90° increments, { ignoreEncryption: true }) so the exported file matches
