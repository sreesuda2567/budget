    ...
    ***************************************************************************** */
    ...
    var PdfAnnotatorModalComponent = /** @class */ (function () {
                ...
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, pdfLib.PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true })];
                        case 2:
                            pdfDoc = _l.sent();
                            modified = false;
                            ...
                            _l.label = 3;
                        case 3:
                            if (!(i >= 0), { ignoreEncryption: true }) return [3 /*break*/, 8];
                            pNum = i + 1;
                        ...
                        case 9:
                            ...
                            loadingTask = pdfjsLib__namespace.getDocument({ data: this.basePdfBytes });
                            _k = this;
                ...
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, pdfLib.PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true })];
                        case 5:
                            sourceDoc = _l.sent(, { ignoreEncryption: true });
        ...
        PdfAnnotatorModalComponent.prototype.undoPageOp = function () {
            return __awaiter(this, void 0, void 0, function () {
                var snapshot, copy, loadingTask, _j, tmpDoc, _1, toast, err_1;
                var _this = this;
                return __generator(this, function (_k) {
                    switch (_k.label) {
                        ...
                        case 3:
                            _k.trys.push([3, 5, , 6]);
                            return [4 /*yield*/, pdfLib.PDFDocument.load(copy, { ignoreEncryption: true })];
                        case 4:
                            tmpDoc = _k.sent();
                            tmpDoc.getPages().forEach(function (pg, idx) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_k) {
                    switch (_k.label) {
                        ...
                        case 4:
                            _k.trys.push([4, 6, , 7]);
                            return [4 /*yield*/, pdfLib.PDFDocument.load(buffer, { ignoreEncryption: true })];
                        case 5:
                            tmpDoc = _k.sent();
                            tmpDoc.getPages().forEach(function (pg, idx) {
                                var _j = pg.getSize(), width = _j.width, height = _j.height;
        ...
        PdfAnnotatorModalComponent.prototype.insertBlankPage = function (where) {
            return __awaiter(this, void 0, void 0, function () {
                var pdfDoc, pages, refPage, _j, width, height, pageW, pageH, insertIndex, newBytes, shiftPage_1, shiftAnnotations, shiftRecord, copy, loadingTask, _k, tmpDoc, _4, toast, err_2, toast;
                var _this = this;
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        case 0:
                        ...
                        case 2:
                            ...
                            _j = refPage.getSize(, { ignoreEncryption: true }), width = _j.width, height = _j.height;
                            pageW = void 0;
                            pageH = void 0;
        ...
        PdfAnnotatorModalComponent.prototype.doDeletePage = function () {
            return __awaiter(this, void 0, void 0, function () {
                var pdfDoc, deleteIndex, newBytes, deletedPage_1, filterAndShift, shiftDeleteRecord, copy, loadingTask, _j, tmpDoc, _5, toast, err_3, toast;
                var _this = this;
                return __generator(this, function (_k) {
                    switch (_k.label) {
                        case 0:
                        ...
                        case 2:
                            ...
                            pdfDoc.removePage(deleteIndex, { ignoreEncryption: true });
                            return [4 /*yield*/, pdfDoc.save()];
                        case 3:
                            newBytes = _k.sent();
                            this.basePdfBytes = newBytes.buffer;
        ...
        PdfAnnotatorModalComponent.prototype.onThumbFileSelected = function (event) {
            return __awaiter(this, void 0, void 0, function () {
                var input, file, reader, arrayBuffer, importedPdf, mainPdf, importedPages, insertIndex, currentIndex, importedPages_1, importedPages_1_1, page, newBytes, insertedCount_1, shiftPage_2, shiftAnnotations, shiftRecord, copy, loadingTask, _j, tmpDoc, _6, toast, err_4, toast, toast;
                var e_10, _k;
                var _this = this;
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        ...
                        case 3:
                            arrayBuffer = _l.sent();
                            return [4 /*yield*/, pdfLib.PDFDocument.load(arrayBuffer, { ignoreEncryption: true })];
                        case 4:
                            importedPdf = _l.sent(, { ignoreEncryption: true });
                            return [4 /*yield*/, pdfLib.PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true })];
                        case 5:
                            mainPdf = _l.sent(, { ignoreEncryption: true });
        ...
        PdfAnnotatorModalComponent.prototype.reorderPage = function (fromPage, toPage) {
            return __awaiter(this, void 0, void 0, function () {
                var pdfDoc, fromIdx, toIdx, _j, copiedPage, insertAt, newBytes, shiftAnnot, shiftRecord, copy, loadingTask, _k, tmpDoc, err_5;
                var _this = this;
                return __generator(this, function (_l) {
                    switch (_l.label) {
                        case 0:
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, pdfLib.PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true })];
                        case 2:
                            pdfDoc = _l.sent(, { ignoreEncryption: true });
                            fromIdx = fromPage - 1;
                            toIdx = toPage - 1;
        ...
        PdfAnnotatorModalComponent.prototype.swapPages = function (pageA, pageB) {
            return __awaiter(this, void 0, void 0, function () {
                var pdfDoc, idxA, idxB, _j, copyOfB, _k, copyOfA, newBytes, swapAnnot, swapRecord, copy, loadingTask, _l, tmpDoc, _7, err_6, toast;
                var _this = this;
                return __generator(this, function (_m) {
                    switch (_m.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, pdfLib.PDFDocument.load(this.basePdfBytes, { ignoreEncryption: true })];
                        case 2:
                            pdfDoc = _m.sent(, { ignoreEncryption: true });
                            idxA = pageA - 1;
                            idxB = pageB - 1;
        ...
        PdfAnnotatorModalComponent.prototype.saveDocument = function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                var pdfDoc, fontkit, fontBytes, thaiFont, boldFontBytes, thaiFontBold, pdfPages, i, pNum, flip, pg, newAngle, annotatedPageNums_1, wmPages, batchSize, _loop_1, this_1, i, form, _j, _k, ff, pgIdx, pdfPage, _l, pgW, pgH, rotAngle, isRotated, vW, vH, fx, fw, fh, fy, borderW, opts, tf, cb, rg, pdfBytes, e_23;
                var e_24, _m;
                var _this = this;
                return __generator(this, function (_o) {
                    switch (_o.label) {
                        ...
                        case 2:
                            ...
                            pdfDoc.registerFontkit(fontkit, { ignoreEncryption: true });
                                ...
                                return __generator(this, function (_x) {
                                    switch (_x.label) {
                                        ...
                                        case 12:
                                            ...
                                            try {
                                                for (stampsForPage_1 = (e_29 = void 0, __values(stampsForPage)), stampsForPage_1_1 = stampsForPage_1.next(); !stampsForPage_1_1.done; stampsForPage_1_1 = stampsForPage_1.next()) {
                                            ...
                                            _loop_2 = function (tb) {
                                                ...
                                                try {
                                                    for (var lines_1 = (e_32 = void 0, __values(lines)), lines_1_1 = lines_1.next(); !lines_1_1.done; lines_1_1 = lines_1.next()) {
                                                        ...
                                                        var line = '';
                                                        try {
                                                            for (var paraWords_1 = (e_33 = void 0, __values(paraWords)), paraWords_1_1 = paraWords_1.next(); !paraWords_1_1.done; paraWords_1_1 = paraWords_1.next()) {
                                            ...
                                            try {
                                                for (textForPage_1 = (e_30 = void 0, __values(textForPage)), textForPage_1_1 = textForPage_1.next(); !textForPage_1_1.done; textForPage_1_1 = textForPage_1.next()) {
                                        ...
                                        case 13:
                                            ...
                                            imgForPage_1 = (e_26 = void 0, __values(imgForPage)), imgForPage_1_1 = imgForPage_1.next();
                                            _x.label = 14;
                                        case 14:
                                        ...
                                        case 26:
                                            ...
                                            sigForPage_1 = (e_28 = void 0, __values(sigForPage)), sigForPage_1_1 = sigForPage_1.next();
                                            _x.label = 27;
                                        case 27:
                                        ...
                                        case 35:
                                            ...
                                            try {
                                                for (dateForPage_1 = (e_31 = void 0, __values(dateForPage)), dateForPage_1_1 = dateForPage_1.next(); !dateForPage_1_1.done; dateForPage_1_1 = dateForPage_1.next()) {
    ...
    PdfAnnotatorModalComponent.propDecorators = {
        ...
        stampFileInputRef: [{ type: core.ViewChild, args: ['stampFileInput', { static: false },] }],
